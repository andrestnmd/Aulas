...
public class UsuarioController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cs.criar(usuario);
		usuario = cs.carregar(usuario.getNome(),usuario.getRg(),usuario.getCpf(),usuario.getSexo(),usuario.getConta(),usuario.getSenha(),usuario.getHorarioEntrada(),usuario.getHorarioSaida(),usuario.getTipo());
